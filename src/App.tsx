...
import DeploymentsPage from './pages/deployments/ui';
...
const ContentWrapper = ({ children }: { children: ReactNode }) => {
  ...
  const isDeployments = location.pathname.startsWith('/deployments');
